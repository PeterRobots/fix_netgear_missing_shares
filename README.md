...
!(https://github.com/PeterRobots/fix_netgear_missing_shares/blob/main/netgear_share.png)
...
4) List the contents of the share configuration folder for your missing share
	...
	- If the `.conf` files are mostly size 0, then they are corrupt and likely can be fixed with this method
	 !(https://github.com/PeterRobots/fix_netgear_missing_shares/blob/main/netgear_broken_share_configs.png)
...
!(https://github.com/PeterRobots/fix_netgear_missing_shares/blob/main/script_example_output.png)
